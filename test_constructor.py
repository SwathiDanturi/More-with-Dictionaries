...
def test_init_constructor_with_path():
    """
    Testing constructor of scrabble_letters with absolute path of the file
    """
    file_path = 'C:/Users/Swath/courses/comp801/homework/h2/scrabblesample.csv'
...
def test_init_constructor_with_filename():
    """
    Testing constructor of scrabble_letters with the file name
    """
